// src/components/Day/DayChart.jsx
import React, { useEffect, useRef } from "react"
import { getStyle } from "@coreui/utils"
import { CChart } from "@coreui/react-chartjs"

export const DayChart = ({ labels, values, selectedYear, selectedMonth, selectedDay }) => {
  ...
  const options = {
    responsive: true,
    plugins: { legend: { labels: { color: getStyle("--cui-body-color") } } },
    scales: {
      x: {
