...
const ExpiringBarChart = ({ data = [] }) => {
  ...
  if (total === 0) {
    return (
      <Container className="p-0">
        ...
        >
          <Card.Body>
            <Card.Title>Expiring Over Time</Card.Title>
            <p>No expiring data available to display.</p>
          </Card.Body>
        </Card>
      </Container>
    );
  ...
  return (
    <Container className="p-0">
      ...
      >
        <Card.Body>
          <Card.Title className="mb-4">Expiring Contract</Card.Title>
...
export default ExpiringBarChart;
