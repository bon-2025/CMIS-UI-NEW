...
const RenewedBarChart = ({ data = [] }) => {
  ...
  if (total === 0) {
    return (
      <Container className="p-0">
        ...
        >
          <Card.Body>
            <Card.Title>Renewed Over Time</Card.Title>
            <p>No renewed data available to display.</p>
          </Card.Body>
        </Card>
      </Container>
    );
  ...
  return (
    <Container className="p-0">
      ...
      >
        <Card.Body>
          <Card.Title className="mb-4">Renewed Contract</Card.Title>
